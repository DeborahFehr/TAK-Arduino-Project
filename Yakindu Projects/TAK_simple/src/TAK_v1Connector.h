...
#ifndef TAK_V1CONNECTOR_H
#define TAK_V1CONNECTOR_H

#include <Arduino.h>
#include "../src-gen/HardwareConnector.h"
#include "../src-gen/TAK_v1.h"

class TAK_v1Connector: public HardwareConnector {
public:
	TAK_v1Connector(TAK_v1* statemachine);

	inline ~TAK_v1Connector();
...
TAK_v1Connector::~TAK_v1Connector() {
}

#endif /* TAK_V1CONNECTOR_H */
